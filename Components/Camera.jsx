...
const CameraComponent = ({ navigation, route }) => {
    ...
    const openImagePickerAsync = async () => {
        ...
        if (route.params.updateProfile) return navigation.navigate("update", { image: data.uri })
        if (route.params.addPost) return navigation.navigate("addPost", { image: data.uri })
